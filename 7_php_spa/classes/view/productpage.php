...
class productPage extends \view\htmlDoc
{
    ...
    private function displayProductDetails()
    {
        ...
        // LEFT COLUMN
        echo '<div class="img_highlight">' . PHP_EOL
        ...
        // RIGHT COLUMN
        echo '<div class="right-column">' . PHP_EOL;
        ...
        echo '<div class="rating-container" data-product-id="' . $productId . '">' . PHP_EOL
            ...
            .'<div class="star-rating">' . PHP_EOL
            .'<div class="stars-backdrop">★★★★★</div>' . PHP_EOL
            .'<div class="stars-overlay">★★★★★</div>' . PHP_EOL
             .'</div>' . PHP_EOL
        ...
        echo '</div>' . PHP_EOL; // End of rating-summary
        echo '</div>' . PHP_EOL; // End of rating-container
        
        echo '</div>' . PHP_EOL; // End of right-column
        echo '</div>' . PHP_EOL; // End of product_container
